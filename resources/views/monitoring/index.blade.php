    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                x-init="
                    fetchLatestData();
                    intervalId = setInterval(() => $data.fetchLatestData(), 10000);
                ...
                <div x-show="!isLoading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <template x-for="(patient, id) in patientsData" :key="id">
                        ...
                        <div class="overflow-hidden shadow-sm sm:rounded-lg border"
                             :class="{
                                 'bg-gray-50 border-gray-300': patient.status === 'no_data',
                                 'bg-white border-blue-500': patient.status === 'normal', /* Azul para normal */
                                 'bg-yellow-50 border-yellow-400': patient.status === 'moderate',
                                 'bg-red-50 border-red-500': patient.status === 'high'
                             }">
                            <div class="p-6 text-gray-900">
                                ...
                                <div class="flex justify-between items-start mb-4">
                                    <div>
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <template x-if="patient.status === 'high'">
                                                <svg class="h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                                                </svg>
                                            </template>
                                            <template x-if="patient.status === 'moderate'">
                                ...
                                <template x-if="patient.latestVitals">
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex justify-between items-center border-t pt-2">
                                            ...
                                            <span class="text-lg font-bold"
                                                  :class="{
                                                      'text-gray-900': patient.status === 'normal' || patient.status === 'no_data',
                                                      'text-yellow-600': patient.status === 'moderate',
                                                      'text-red-600': patient.status === 'high'
                                                  }">
                                ...
                                <template x-if="!patient.latestVitals">
                                    <p class="text-sm text-gray-500 text-center py-4">Aguardando dados...</p>
                                </template>
