                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('devices.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="device_name" class="block mt-1 w-full" type="text" name="device_name" :value="old('device_name')" required autofocus placeholder="Ex: Pulseira Quarto 101"/>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="unique_device_id" class="block mt-1 w-full" type="text" name="unique_device_id" :value="old('unique_device_id')" required placeholder="Ex: AABB-CCDD-1234 (ID que está no seu Arduino)"/>
                        ...
                        <div class="mt-4">
                            ...
                            {{-- O 'required' foi removido do <select> --}}
                            <select name="patient_id" id="patient_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                {{-- Esta opção com value="" significa "Nenhum" --}}
                        ...
                        <div class="flex items-center justify-end mt-6 space-x-4">
                            <a href="{{ request()->get('redirect_to', route('devices.index')) }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
                                {{ __('Voltar') }}
                            </a>
                
                            <x-primary-button>
                                {{ __('Salvar Dispositivo') }}
                            </x-primary-button>
                        </div>
                    </form>
                </div>
